#ifndef RRT_PLANNER_NODE_HPP
#define RRT_PLANNER_NODE_HPP
...
class RRTPlannerNode : public rclcpp_lifecycle::LifecycleNode {
public:
  explicit RRTPlannerNode(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  void on_shutdown();
protected:
